...
You will create a console-based Task List Management Application that satisfies the
...
As part of this application, you must decide how to store your data both internally
(int RAM) and externally (on the hard drive).

Your solution must encapsulate item data in a class called TaskItem and list data in
a class called TaskList.

Your solution must possess a class called App to handle interaction with the user.

You must have automated JUnit tests for all of the behaviors required in a TaskList.
- You must test both expected successes and expected failures, such as trying to
  remove or change part of an item that doesn't exist.
 */
